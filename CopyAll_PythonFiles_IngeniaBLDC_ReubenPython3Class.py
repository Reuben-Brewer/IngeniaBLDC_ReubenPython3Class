...
try:
    ...
    shutil.copy("G:\\My Drive\\CodeReuben\\IngeniaBLDC_ReubenPython3Class\\ResetWinPCAPdriver.py", FileDirectoryToCreate)
    shutil.copy("G:\\My Drive\\CodeReuben\\IngeniaBLDC_ReubenPython3Class\\ResetWinPCAPdriver.bat", FileDirectoryToCreate)
