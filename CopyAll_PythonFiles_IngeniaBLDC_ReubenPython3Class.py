...
FileWorkingDirectory = "D:\\" #Use "D:\\" if the filepath length is too long
#FileWorkingDirectory = os.getcwd() #Use "D:\\" if the filepath length is too long
...
try:
    ...
    shutil.copy("G:\\My Drive\\CodeReuben\\ReubenGithubCodeModulePaths\\ReubenGithubCodeModulePaths.py", FileDirectoryToCreate)

    shutil.copy("G:\\My Drive\\CodeReuben\\IngeniaBLDC_ReubenPython3Class\\__init__.py", FileDirectoryToCreate)
    ...
    shutil.copy("G:\\My Drive\\CodeReuben\\GetCPUandMemoryUsageOfProcessByPID_ReubenPython3Class\\GetCPUandMemoryUsageOfProcessByPID_ReubenPython3Class.py", FileDirectoryToCreate)
    #shutil.copy("G:\\My Drive\\CodeReuben\\GetCPUandMemoryUsageOfProcessByPID_ReubenPython3Class\\test_program_for_GetCPUandMemoryUsageOfProcessByPID_ReubenPython3Class.py", FileDirectoryToCreate)
