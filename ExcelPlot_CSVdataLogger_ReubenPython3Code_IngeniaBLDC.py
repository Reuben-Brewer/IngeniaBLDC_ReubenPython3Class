...
Verified working on: Python 3.12 for Windows 8.1, 10, and 11 64-bit (haven't tested on Ubuntu, Raspberry Pi, or Mac yet).
'''
...
def CreateExcelChart(FileName_to_save_full_path, DataOrderedDictToWrite):
    ...
    try:
        ...
        ##########################################################################################################
        ##########################################################################################################
        VariableNamesListToInludeOnSinglePlotVsTime = ["CurrentQuadrature_Actual"]
